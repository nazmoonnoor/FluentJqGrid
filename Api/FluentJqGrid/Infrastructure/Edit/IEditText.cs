namespace FluentJqGrid.Infrastructure.Edit
{
    public interface IEditText
    {
        ...
        /// <input type="text" ...../>
        /// This sets the size attribute of text
        /// </summary>
        /// <param name="size"></param>
        /// <returns></returns>
        IEditText Size(int size);

        /// <summary>
        /// When edittype is 'text', jqGrid constructs a input tag of type text
        /// <input type="text" ...../>
        /// This sets the maxlength attribute of text
        /// </summary>
        /// <param name="maxLength"></param>
        /// <returns></returns>
        IEditText MaxLength(int maxLength);

        /// <summary>
        /// When edittype is 'text', jqGrid constructs a input tag of type text
        /// <input type="text" ...../>
        /// This sets the readonly attribute of text
        /// </summary>
        /// <param name="readOnly"></param>
        /// <returns></returns>
        IEditText ReadOnly(bool readOnly);
        ...
        /// <returns></returns>
        IEditText DataInit(string dataInit);
        ...
        /// <returns></returns>
        IEditText DataEvents(string dataEvents);
        ...
        /// <returns></returns>
        IEditText DefaultValue(string defaultValue);
        ...
        /// <returns></returns>
        IEditText NullIfEmpty(bool nullIfEmpty);

        /// <summary>
        /// All possible attributes for 'text' input
        /// </summary>
        /// <param name="attributes"></param>
        IEditText Attributes(string attributes);
    }
}