namespace FluentJqGrid.Infrastructure.Edit
{
    public interface IEditButton
    {
        ...
        /// <returns></returns>
        IEditButton Value(string value);
        ...
        /// <returns></returns>
        IEditButton DataInit(string dataInit);
        ...
        /// <returns></returns>
        IEditButton DataEvents(string dataEvents);
        ...
        /// <returns></returns>
        IEditButton DefaultValue(string defaultValue);
        ...
        /// <returns></returns>
        IEditButton NullIfEmpty(bool nullIfEmpty);

        /// <summary>
        /// All possible attributes for 'button' input
        /// </summary>
        /// <param name="attributes"></param>
        IEditButton Attributes(string attributes);
    }
}