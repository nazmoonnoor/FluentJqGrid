...
{
    public interface IEditTextArea
    {
        /// <summary>
        /// When edittype is 'textarea', jqGrid constructs a input tag of type textarea
        /// This sets the 'row' attribute for textarea
        /// </summary>
        /// <param name="rows"></param>
        /// <returns></returns>
        IEditTextArea Rows(int rows);

        /// <summary>
        /// When edittype is 'textarea', jqGrid constructs a input tag of type textarea
        /// This sets the 'col' attribute for textarea
        /// </summary>
        /// <param name="cols"></param>
        /// <returns></returns>
        IEditTextArea Cols(int cols);
        ...
        /// <returns></returns>
        IEditTextArea DataInit(string dataInit);
        ...
        /// <returns></returns>
        IEditTextArea DataEvents(string dataEvents);
        ...
        /// <returns></returns>
        IEditTextArea DefaultValue(string defaultValue);
        ...
        /// <returns></returns>
        IEditTextArea NullIfEmpty(bool nullIfEmpty);

        /// <summary>
        /// All possible attributes for 'textarea' input
        /// </summary>
        /// <param name="attributes"></param>
        IEditTextArea Attributes(string attributes);
    }
}